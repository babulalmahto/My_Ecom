...
function CreateProduct() {
  ...
  async function submitProductHandler(e)
  {
    try{
        ...
        let res= await axios.post('/api/ecom/create-product',formData,{headers:{"Content-Type":"multipart/form-data",Authorization:auth.token,}})
        if(res.data.success)
        {  
      ...
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="col-md-9">
            <h4 className="text-center m-3" style={{color:"#429e50"}}> Create Product </h4>
            <hr />
            ...
            <div className="mt-4 mb-4">
              <button className="btn btn-primary" onClick={submitProductHandler}><IoIosCreate /> Create Product</button>
            </div>
